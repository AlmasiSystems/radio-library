...
$query = "SELECT event_id,event_title,event_day,event_starttime FROM $db_table WHERE event_month='$month' AND event_year='$year' ORDER BY event_starttime";
...
while ($info = mysql_fetch_array($query_result))
{
    ...
    $event_info[$event_id]['1'] = $info['event_starttime'];
}
...
<div align="center">
    ...
    <p>
        Use the calendar below to view/book times for use of Studio A.
    </p>
	<p>
		<div style="color: red;">NOTE: Studio Bookings cannot be edited.  If you need to change the time / description
			of your booked time, please delete the booking you originally created and add a new one.
		</div>
	</p>
</div>
