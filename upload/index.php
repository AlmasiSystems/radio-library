...
<head>
  ...
  <!-- Please do not remove this tag: Uber-Uploader Ver 6.1 http://uber-uploader.sourceforge.net -->
  <style>
  ...
  <script language="javascript" type="text/javascript">
    ...
    var path_to_ini_script = "<?php print $PATH_TO_INI_SCRIPT; ?>";
    var path_to_staus_script = "<?php print $PATH_TO_STAUS_SCRIPT; ?>";
    ...
    var check_allow_extensions = <?php print $_CONFIG['check_allow_extensions']; ?>;
    <?php if($_CONFIG['check_allow_extensions']){ print "var allow_extensions = /" . $_CONFIG['allow_extensions'] . "$/i;\n"; } ?>
    ...
    var get_status_speed = <?php print $_CONFIG['get_status_speed']; ?>;
...
<body style="background-color: #EEEEEE; color: #000000; font-family: arial, helvetica, sans_serif;" onLoad="iniFilePage()">
  ...
  <div align="center">
    ...
    <h1>Rules</h1>
    <h3>File names must contain less than <font color="red">40 characters</font> and should not contain any weird symbols (or spaces)</h3>
    <h3>Max file size is <font color="red">200mb</font> and only <font color="red">mp3</font> files are allowed to be uploaded</h3>
    <h3>Uploaded files can be viewed here: <a href="http://kdvs.ucdavis.edu/uploads">http://kdvs.ucdavis.edu/uploads</a> </h3>
    <br>
    ...
    <div id="upload_div" style="display:none; width:805; height:205; overflow:auto;"><iframe name="upload_iframe" frameborder="0" width="800" height="200"></iframe></div>
    <?php } ?>
