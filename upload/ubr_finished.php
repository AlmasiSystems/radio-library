...
elseif(isset($_GET['about']) && $_GET['about'] == 1){ kak("<u><b>UBER UPLOADER FINISHED PAGE</b></u><br>UBER UPLOADER VERSION =  <b>" . $UBER_VERSION . "</b><br>UU_FINISHED = <b>" . $THIS_VERSION . "<b><br>\n", 1 , __LINE__); }
...
if($_CONFIG_DATA['send_email_on_upload']){
	...
	ob_implicit_flush(1);
	emailUploadResults($_FILE_DATA_EMAIL, $_CONFIG_DATA, $_POST_DATA);
}
