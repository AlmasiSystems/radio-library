...
elseif(isset($_GET['about']) && $_GET['about'] == 1){ kak("<u><b>UBER UPLOADER LINK</b></u><br>UBER UPLOADER VERSION =  <b>" . $UBER_VERSION . "</b><br>UBR_INI_PROGRESS = <b>" . $THIS_VERSION . "<b><br>\n", 1, __LINE__); }
...
if(!$found_flength_file){
	if($DEBUG_AJAX){ showDebugMessage("Failed to find flength file $flength_file<br>"); }
...
else{ startProgressBar($UPLOAD_ID, $total_upload_size, $start_time); }
