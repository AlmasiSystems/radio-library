...
$THIS_VERSION = "1.1";     // Version of this file
...
elseif(isset($_GET['about']) && $_GET['about'] == 1){ kak("<u><b>UBER-UPLOADER GET UPLOAD STATUS</b></u><br>UBER UPLOADER VERSION =  <b>" . $UBER_VERSION . "</b><br>UBR_GET_STATUS = <b>" . $THIS_VERSION . "<b>", 1, __LINE__); }
