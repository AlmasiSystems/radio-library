...
function initializeProgressBar(upload_id){
	...
	jsel.type = 'text/javascript';
	jsel.src = path_to_ini_script + '?upload_id=' + upload_id;
	dom.appendChild(jsel);
...
function startProgressBar(upload_id, upload_size, start_time){
    ...
    window.onbeforeunload = function (evt) {
      var message = 'Your File Upload Will Be Canceled!';
	...
	get_status_url = path_to_staus_script + '?upload_id=' + upload_id + '&start_time=' + start_time + '&total_upload_size=' + total_upload_size;
	get_data_loop = true;
...
function getProgressStatus(){
	...
	if(get_data_loop){
		...
		timerID = setTimeout("getProgressStatus()", get_status_speed);
	}
}
